                        ...
                        <li><a href="${pageContext.request.contextPath}/aboutus" class="btn">About Us</a></li>
                            ...
                            <li><div class="dropdown"><a href="#" class="btn-prof">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="${pageContext.request.contextPath}/user/user-history?id=${account.username}"><sec:authentication property="principal.username"/>'s History</a>
                                        <a href="${pageContext.request.contextPath}/user/user-info?id=${account.username}"><sec:authentication property="principal.username"/>'s Info</a>
